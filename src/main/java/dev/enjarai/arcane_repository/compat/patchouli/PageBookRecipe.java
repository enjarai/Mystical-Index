package dev.enjarai.arcane_repository.compat.patchouli;
...
public class PageBookRecipe extends PageWithText {
    private static final MysticalBookRecipe RECIPE = new MysticalBookRecipe(ArcaneRepository.id("crafting_special_custom_book"), CraftingRecipeCategory.EQUIPMENT);
...
//        }
    ...
    public Text getTitle() {
        return Text.translatable("item.arcane_repository.repository_book");
    }
