...
public abstract class MildlyLessCringeBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    ...
    protected MildlyLessCringeBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.ctx = ctx;
    }
